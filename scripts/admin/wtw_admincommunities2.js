...
WTWJS.prototype.getSelectCommunitiesList = async function(zfilter) {
	...
	try {
		...
		if (WTW.isUserInRole('admin') || WTW.isUserInRole('developer')) {
			...
			zlistcommunities += " ' onclick=\"WTW.setCommunitiesListTab('all');\">All</div></div>"<div class='wtw-mainmenuvalue'>Admins and Developer Roles can edit <b>All</b> 3D Communities on this server.</div><hr /><div class='wtw-clear'></div>\r\n";
		} else {
		} else {
