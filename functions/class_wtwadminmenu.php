...
class wtwadminmenu {
	...
	public function getAdminMoldMenu() {
		...
		try {
			...
			$zmenu .= "				</div>";
			$zmenu .= "			</div><br />\r\n";
			$zmenu .= "			<div id='wtw_moldscalingydiv' class='wtw-onecol single-item' style='display:inline-block;'>\r\n";
			...
			$zmenu .= "			<div class='mold-colors'>";
			$zmenu .= "				<h2 class='wtw-marginbottom'>Mold Emissive Color (Projected)</h2>";
			$zmenu .= "				<div class='wtw-mainmenuvalue'>(Example: #000000)</div>";
			$zmenu .= "				<input type='text' placeholder='#000000' id='wtw_tmoldemissivecolor' maxlength='7' class='wtw-smallprintinput' onfocus=\"WTW.openMoldColorSelector(this, 'Emissive Color (Projected)', 'emissive');\" onblur='WTW.closeColorSelector(false);WTW.setNewMold();' onchange='WTW.setMoldColorDirect(this);' onkeyup='WTW.setMoldColorDirect(this);' />";
			$zmenu .= "			</div>";
			$zmenu .= "			<div class='mold-colors'>";
			$zmenu .= "				<h2 class='wtw-marginbottom'>Mold Diffuse Color (Base)</h2>";
			$zmenu .= "				<div class='wtw-mainmenuvalue'>(Example: #ffffff)</div><br />";
			$zmenu .= "				<input type='text' placeholder='#000000' id='wtw_tmolddiffusecolor' maxlength='7' class='wtw-smallprintinput' onfocus=\"WTW.openMoldColorSelector(this, 'Diffuse Color (Base)', 'diffuse');\" onblur='WTW.closeColorSelector(false);WTW.setNewMold();' onchange='WTW.setMoldColorDirect(this);' onkeyup='WTW.setMoldColorDirect(this);' />";
			$zmenu .= "			</div>";
			$zmenu .= "			<div class='mold-colors'>";
			$zmenu .= "				<h2 class='wtw-marginbottom'>Mold Specular Color (Highlight)</h2>";
			$zmenu .= "				<div class='wtw-mainmenuvalue'>(Example: #686868)</div><br />";
			$zmenu .= "				<input type='text' placeholder='#000000' id='wtw_tmoldspecularcolor' maxlength='7' class='wtw-smallprintinput' onfocus=\"WTW.openMoldColorSelector(this, 'Specular Color (Highlight)', 'specular');\" onblur='WTW.closeColorSelector(false);WTW.setNewMold();' onchange='WTW.setMoldColorDirect(this);' onkeyup='WTW.setMoldColorDirect(this);' />";
			$zmenu .= "			</div>";
			$zmenu .= "			<div class='mold-colors'>";
			$zmenu .= "				<h2 class='wtw-marginbottom'>Mold Ambient Color (Environment)</h2>";
			$zmenu .= "				<div class='wtw-mainmenuvalue'>(Example: #575757)</div><br />";
			$zmenu .= "				<input type='text' placeholder='#000000' id='wtw_tmoldambientcolor' maxlength='7' class='wtw-smallprintinput' onfocus=\"WTW.openMoldColorSelector(this, 'Ambient Color (Environment)', 'ambient');\" onblur='WTW.closeColorSelector(false);WTW.setNewMold();' onchange='WTW.setMoldColorDirect(this);' onkeyup='WTW.setMoldColorDirect(this);' />";
			$zmenu .= "			</div>";
			$zmenu .= "			<hr class='wtw-menuhr' />\r\n";
			$zmenu .= "		</div>\r\n";
			...
			$zmenu .= "					<div id='wtw_moldsoundmaxdistdiv' class='wtw-onecol wtw-one-items'>";
			$zmenu .= "						<h2 class='wtw-marginbottom'>Max Distance Linear (Default: 100)<br />\r\n</h2>\r\n";
			$zmenu .= "						<div class='wtw-onecol single-item'>";
